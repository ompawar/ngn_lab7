...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        #based on the in_port choose the server
        
        if (in_port == 4 or in_port == 7):
            server_id = 0
            self.counter_1 += 1
        elif(in_port == 5):
            server_id = 1
        ...
        #if one server has served more than 5 requests, then choose next available server
        #make the count of original server as 0
        
        if(server_id == 0 and self.counter_1 > 5 ):
            print("Server 1 overloaded")
            if(self.counter_2 < 5):
                server_id = 1
                self.counter_2 += 1
            elif(self.counter_3 < 5):
                server_id = 2
                self.counter_3 += 1
            else:
                server_id = 0
        ...
        if(server_id == 1 and self.counter_2 > 5 ):
            print("Server 2 overloaded")
            if(self.counter_3 < 5):
                server_id = 2
                self.counter_3 += 1
            elif(self.counter_1 < 5):
                server_id = 0
                self.counter_1 += 1
            else:
                server_id = 1
        ...
        if(server_id == 2 and self.counter_3 > 5 ):
            print("Server 3 overloaded")
            if(self.counter_1 < 5):
                server_id = 0
                self.counter_1 += 1
            elif(self.counter_2 < 5):
                server_id = 1
                self.counter_2 += 1
            else:
                server_id = 2
